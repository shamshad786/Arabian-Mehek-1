  ...
  const images = [
    {
      ...
      fallbackText: "Perfume 1",
    },
    {
      src: "/Darham.webp",
      alt: "Another Perfume Bottle",
      fallbackText: "Perfume 2",
    },
    {
      src: "/Sabaya.webp",
      alt: "Third Perfume Bottle",
      fallbackText: "Perfume 3",
    },
    {
      src: "/Versatile.webp",
      alt: "Fourth Perfume Bottle",
      fallbackText: "Perfume 4",
    },
    {
      src: "/Club.webp",
      alt: "Fifth Perfume Bottle",
      fallbackText: "Perfume 5",
    },
    {
      src: "/Marquis.webp",
      alt: "Fifth Perfume Bottle",
      fallbackText: "Perfume 6",
    },
  ];
...
const Countdown = () => {
  ...
  return (
    <section className="bg-white text-gray-900 flex flex-col items-center justify-center text-center px-4 py-2 md:py-20 font-inter">
      ...
      <h2 className="w-full text-center text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-l from-purple-500 via-orange-500 to-yellow-500 text-transparent bg-clip-text leading-tight px-4 break-words -m-5 mb-1">
        {" "}
        Arabian Mehek is Coming{" "}
      </h2>
      <h2 className="text-xl sm:text-2xl md:text-3xl  leading-tight max-w-5xl animate-pop-in  px-2">
        {" "}
      ...
      <h3 className="text-sm sm:text-base md:text-xl text-lime-950 max-w-3xl animate-pop-in font-semibold mb-6 md:mb-10 px-2">
        ...
        is coming soon and the <span className="text-4xl"> countdown </span>has
        begun <br />
        Be the First to Smell the Difference{" "}
        <span className="bg-gradient-to-r from-yellow-500 via-red-500 to-pink-500 text-transparent bg-clip-text text-xl sm:text-2xl">
          Arabian Mehek is Coming
        </span>
      </h3>
      <h2 className="w-full text-center text-xl sm:text-xl md:text-2xl font-bold bg-gradient-to-l from-purple-500 via-orange-500 to-yellow-500 text-transparent bg-clip-text leading-tight px-4 break-words -mt-6  mb-3">
        {" "}
        Launch In{" "}
      </h2>
      ...
      <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-8 mb-10">
        ...
        <div className="flex flex-col items-center p-6 sm:p-8 bg-gray-200 rounded-xl backdrop-blur-md min-w-[70px] sm:min-w-[90px] md:min-w-[110px] animate-pop-in shadow-md">
          ...
          <span className="text-xs sm:text-sm mt-1 uppercase text-gray-600">
            Days
          </span>
        </div>
      ...
      <h3 className="text-sm sm:text-base md:text-l text-lime-950 max-w-3xl animate-pop-in font-semibold mb-6 md:mb-10 px-">
        Only for Pre-Subscribers – Subscribe Now for 20% Launch Discount Coupon{" "}
        <span className="bg-gradient-to-l from-purple-500 via-orange-500 to-yellow-500 text-transparent bg-clip-text">
          {" "}
          <a href="#form" className=" text-pink-500 underline">
            {" "}
            click here
          </a>{" "}
        </span>{" "}
      ...
      <h3 className="text-sm sm:text-base md:text-xl text-pink-500 max-w-3xl animate-pop-in mb-6 md:mb-10 px-2 flex items-center justify-center text-center gap-2 flex-wrap">
        {" "}
        Beat the Rush – Pre-Order Now & Save 20% Off Before It’s Gone.{" "}
        <a href="https://wa.link/olfd8b"></a>
      </h3>

      <Link
        href="/"
        className="text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 font-medium rounded-lg text-base sm:text-lg md:text-xl px-5 py-3 text-center -mt-5"
      >
        {" "}
        Pre Order Now
      </Link>
